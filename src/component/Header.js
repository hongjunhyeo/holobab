      ...
      <nav className="banner-nav">
        <ul className="banner-nav-list">
          ...
          <li className="banner-nav-item">
            ...
            <ul className="dropdown-menu">
              <li className="dropdown-item"><span onClick={() => onClickNavigate("/Notices")}>공지사항</span></li>
          ...
          <li className="banner-nav-item">
            ...
            <ul className="dropdown-menu">
              ...
              <li className="dropdown-item"><span onClick={() => onClickNavigate("/Suggestions")}>F&A 시스템 건의사항</span></li>
            </ul>
          </li>
        </ul>
      </nav>
