          ...
          <tbody>
            {boardList.length === 0 ? (
              ...
              boardList.map((board, index) => (
                ...
                >
                  <td className="boardnumber">{currentPage * pageSize + index + 1}</td>
                  <td className="boardtitle">{board.title}</td>
                  <td className="boardwriter">{board.writerName}</td>
                  <td className="boarddate">{board.date}</td>
                </tr>
              ))
            )}
          </tbody>
