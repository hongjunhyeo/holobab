      ...
      <form className="board-form">
        <table className="board-detail-table">
          ...
          <tbody>
                  ...
                  <div className="board-files">
                    {boardDetail.files.map((file, index) => (
                      <p key={index}>
                        {file.originalName}{" "}
                        <a
                          href={`http://localhost:8090/opereation/download?filePath=${encodeURIComponent(
                            file.storedPath
                          )}`}
                          download
                        >
                ...
                <div className="board-comments">
                  {boardDetail.comments.map((comment, index) => (
                    <div key={index} className="comment-box">
                      ...
                      {(String(comment.userID) === String(currentUserID) || decodedToken.roles.includes("ROLE_ADMIN")) && (
                          <button
            ...
            {(String(boardDetail.writerID) === String(currentUserID) || decodedToken.roles.includes("ROLE_ADMIN")) ? (
                <tr>
