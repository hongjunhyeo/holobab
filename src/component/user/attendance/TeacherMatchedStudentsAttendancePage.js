...
const TeacherMatchedStudentsAttendancePage = () => {
  ...
  return (
    <div className="teachermatchedstudentattendance-body">
      <Sidebar />
      <form className="teachermatchedstudentattendance-container">
        <h2>매칭된 학생의 출석 기록</h2>
            ...
            <tbody>
              {attendanceRecords.map((record) => (
                <tr key={record.attendanceId}>
                  ...
                  <td>{translateAttendanceStatus(record.status) || "정보 없음"}</td>
                </tr>
              ))}
            </tbody>
          </table>
